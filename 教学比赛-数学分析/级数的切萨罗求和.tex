...
\author[Cesàro\\可和级数] % Your institution as it will appear on the bottom of every slide, maybe shorthand to save space
...
\begin{align*}
& (c, 0): \quad s_n = \sum\limits_{k=1}^n a_n \text{ 收敛} \\
...
\pause
\vspace{0.8em}
\item[{\larger[2] \color{red} \ding{43}}] Tauber 型定理:
\[
\left. \begin{array}{r}
