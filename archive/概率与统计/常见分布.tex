...
\begin{align*}
f(y) & = \int_{-\infty}^{+\infty} f_{X_1}(x_1) f_{X_2}(y-x_1) ~ \mathrm{d}x_1 = \int_{0}^{y} \lambda e^{-\lambda x_1} \cdot \lambda e^{-\lambda (y-x_1)} ~ \mathrm{d}x_1 \\
& = \lambda^2 \int_{0}^{y} e^{-\lambda y} ~ \mathrm{d}x_1 = \lambda^2 y e^{-\lambda y}
\end{align*}
