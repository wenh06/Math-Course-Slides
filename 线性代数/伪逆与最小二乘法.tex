...
回到解线性方程组$A\mathbf{x} = \mathbf{b}$的问题。我们知道当$A$是可逆方阵的时候，该线性方程组有唯一解$\mathbf{x} = A^{-1}\mathbf{b}$.
...
\Longrightarrow & A (\widehat{\mathbf{x}}_0-\mathbf{x}^+) = \mathbf{0}0
\end{align*}
