...
\textbf{至多可列}: 各 $I_x$ 互不相交, 每个含至少一个有理数, 不同的含不同的有理数, 故个数至多可列. $\square$
...
若 $G = \bigcup_k (a_k, b_k)$ 是另一个至多可列互不相交开区间分解, 则对每个 $x \in G,$ $x$ 所在的区间 $(a_k, b_k)$ 是一个包含 $x$ 的开区间且 $\subset G,$ 故 $(a_k, b_k) \subset I_x.$ 反之 $I_x \subset (a_k, b_k)$ 由极大性. 故两种分解的构成区间相同. $\square$
