...
\begin{itemize}
\item \circled{1} 若 $E/F$, $L/F$ 为有限扩张, 则 $E \cdot L/F$ 也为有限扩张;
\item \circled{2} 若 $E/F$, $L/F$ 为代数扩张, 则 $E \cdot L/F$ 也是代数扩张;
\item \circled{3} 若 $E/F$, $L/F$ 为正规扩张, 则 $E \cdot L/F$ 也是正规扩张;
\item \circled{4} 若 $E/F$, $L/F$ 为可分扩张, 则 $E \cdot L/F$ 也是可分扩张;
\item \circled{5} 若 $E/F$, $L/F$ 为纯不可分扩张, 则 $E \cdot L/F$ 也是纯不可分的;
\item \circled{6} 若 $E/F$, $L/F$ 为 Galois 扩张, 则 $E \cdot L/F$ 也是 Galois 扩张.
\end{itemize}
\end{block}
