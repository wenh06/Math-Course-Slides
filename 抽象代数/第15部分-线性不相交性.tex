...
\begin{itemize}
\item 注:
\item \circled{1} $F^{\frac{1}{p^n}}/F$ 为纯不可分扩张;
\item \circled{2} $[F]_i := F^{\frac{1}{p^{\infty}}}$ 为纯不可分闭包;
\item \circled{3} $(F^{\frac{1}{p^n}})^p = F$.
\end{itemize}
...
\startproof[bg=yellow, fg=red](证明)
$1^{\circ}$. $E/F$ 为可分扩张:
首先, \circled{1} 任一扩张 $E/F$, 有 $F \cdot E^p = E$;
...
\circled{2} $\forall\ \{ \alpha_1, \dots, \alpha_n \} \subset E$,
在 $F^{\frac{1}{p}}$ 上线性无关
...
要证明 $E$ 与 $F^{\frac{1}{p}}$ 线性不相交, 但由 \circled{1} 知仅需证明
...
令 $F_1 = F(\alpha_1, \dots, \alpha_n)$, 由 \circled{1} 知 $F \cdot F_1^p = F_1$.
