...
\begin{equation*}
f(x) \in \mathcal{R}[a, b] \quad \stackanchor[6pt]{$\Longrightarrow$}{$\bcancel{\Longleftarrow}$} \quad |f(x)| \in \mathcal{R}[a, b]
\end{equation*}
那么反常积分的情况如何?
\end{question}
...
\begin{empheq}[box={\fancymath[colback=cyan!30, drop lifted shadow, sharp corners]}]{equation*}
\text{$f(x)$ 反常积分收敛 $\bcancel{\Longrightarrow}$ $|f(x)|$ 反常积分收敛}
\end{empheq}
