...
\item 乘积可积性: $f, g \in \mathcal{R}[a, b] \implies f \cdot g \in \mathcal{R}[a, b].$
\item 保序性: $f \leqslant g \implies \int_a^b f(x) ~ \mathrm{d} x \leqslant \int_a^b g(x) ~ \mathrm{d} x.$
\item 绝对可积性: $f \in \mathcal{R}[a, b] \implies \lvert f \rvert \in \mathcal{R}[a, b]$ ({\color{red}反之不成立}), 且有
...
\[f(x) \in \mathcal{R}[a, b] ~~ \substack{\implies \\ \centernot\Longleftarrow} ~~ \lvert f(x) \rvert \in \mathcal{R}[a, b]\]
在反常积分中正好反过来了:
