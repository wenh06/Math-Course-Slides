...
\begin{attnblock}
由不等式
$$\varliminf\limits_{n\to\infty} \dfrac{a_{n+1}}{a_n} \leqslant \varliminf\limits_{n\to\infty} \sqrt[n]{a_n} \leqslant {\color{red}\varlimsup\limits_{n\to\infty} \sqrt[n]{a_n}} \leqslant \varlimsup\limits_{n\to\infty} \dfrac{a_{n+1}}{a_n},$$
若知道 $\varliminf\limits_{n\to\infty} \dfrac{a_{n+1}}{a_n}$ 或 $\varliminf\limits_{n\to\infty} \sqrt[n]{a_n}$ 或 $\varlimsup\limits_{n\to\infty} \dfrac{a_{n+1}}{a_n},$ 那么只能得到关于收敛半径的不等式估计.

\pause
\vspace{0.6em}

反过来, 如果知道收敛半径, 那么可以知道 $\varlimsup\limits_{n\to\infty} \sqrt[n]{a_n}$ 的值, 但是不能得到 $\lim\limits_{n\to\infty} \sqrt[n]{a_n}$ 的值, 甚至极限是否存在都不能 (仅依据收敛半径) 下结论.
