...
# server set up.
c.CourseDirectory.course_id = "数学分析"

c.IncludeHeaderFooter.header = "source/header.ipynb"

# 自定义 solution stub：保留提示信息，方便学生知道需要删掉这行
c.ClearSolutions.code_stub = {
    "python": "# 请在此处填写你的代码\nraise NotImplementedError('请删掉或注释掉这行，并实现本函数')\n"
}
...
#  Default: {'ir': <function InstantiateTests.<lambda> at 0x7f68007d20e0>, 'python': <function InstantiateTests.<lambda> at 0x7f68007d2320>, 'python3': <function InstantiateTests.<lambda> at 0x7f68007d23b0>}
# c.InstantiateTests.sanitizers = {'ir': <function InstantiateTests.<lambda> at 0x7f68007d20e0>, 'python': <function InstantiateTests.<lambda> at 0x7f68007d2320>, 'python3': <function InstantiateTests.<lambda> at 0x7f68007d23b0>}
